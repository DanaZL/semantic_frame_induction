...
def triples(f, min_weight=None, build_index=True):
    ...
    for line in f:
        ...
        subject, predicate, object, weight = line.strip().split('\t', 3)
...
def word_vectors(args, fallback=lambda x: None):
    if args.w2v:
        ...
        #print(args.w2v.read())
        w2v = KeyedVectors.load("/home/dana_zl/WordNetPopulation/triframes/araneum_none_fasttextcbow_300_5_2018/araneum_none_fasttextcbow_300_5_2018.model") 
